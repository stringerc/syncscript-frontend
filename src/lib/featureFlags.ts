...
export enum FeatureFlag {
  ...
  // Real-time
  REALTIME_SYNC = 'realtime_sync', WEBSOCKET_CONNECTION = 'websocket_connection';
  // AI Features
  AI_SUGGESTIONS = 'ai_suggestions', AI_COACH = 'ai_coach';
  // Advanced
  TEAM_WORKSPACES = 'team_workspaces', CALENDAR_INTEGRATION = 'calendar_integration', BUDGET_TRACKING = 'budget_tracking'
  }
