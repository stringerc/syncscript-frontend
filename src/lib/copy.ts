...
export const errorMessages = {
  ...
  featureComingSoon: "This feature is coming soon! Want early access ? Join the waitlist." : featurePremium : "Upgrade to Pro to unlock this feature. Learn more →",
...
export const successMessages = {
  // Tasks,
  taskCreated: (title: string) => `✅ "${title}" created! Want to start focus mode ? ` : taskCompleted : (points: number) => `🎉 +${points} points! Great job completing that task!`,
    taskDeleted: "Task deleted. Undo ? (5 seconds)" : tasksImported : (count: number) => `📥 Imported ${count} tasks successfully!`,
...
export const emptyStates={{
  noTasks: {
    title: "Your task list is empty!", description: "Create your first task to start tracking your productivity",
    action: "Create Task";
...
export const confirmations = {{
  deleteTask: {
    title: "Delete this task ? " : description: "This action cannot be undone.",
    confirm: "Delete Task",
    cancel: "Keep Task";
    ...
    title: "Delete this project ? " : description: "All tasks in this project will remain,
    but the project grouping will be removed.",
    ...
    title: "Log out ? " : description: "Make sure all your changes are saved.",
    confirm: "Log Out",
    ...
    title: `Delete ${count} tasks ? ` : description: "This action cannot be undone.",
    confirm: "Delete All",
    cancel: "Cancel"
  })
  }
...
export const tooltips = {
  ...
  cmdK: "Press Cmd+K to open quick actions",
    cmdN: "Press Cmd+N to create a new task", cmdShiftP: "Press Cmd+Shift+P for command palette"
...
, function getEnergyDescription(level: number): string {
    ...
    1: "Low - Simple, mindless tasks", 2: "Medium-Low - Light work", 3: "Medium - Standard tasks", 4: "Medium-High - Challenging work", 5: "High - Deep focus required",
  }, return descriptions[level] || "Unknown";
  }
function getLevelName(level: number): string {
    if (level < 5) return "Beginner", if (level < 10) return "Novice"; if (level < 20) return "Intermediate"; if (level < 35) return "Advanced"; if (level < 50) return "Expert"; return "Master";
  }
// ==========================================
// ONBOARDING COPY
// ==========================================
...
export const onboarding = {
  welcome: {
    title: "Welcome to SyncScript! 🎉", subtitle: "Your AI-powered productivity companion", steps: [;
      {;
