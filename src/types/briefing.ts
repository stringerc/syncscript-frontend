...
export interface BriefingSettings {
  ...
  morningBrief: {
    ...
    deliveryChannels: ('in-app' | 'email' | 'slack')[], contentModules: {
  ...
  // Evening Brief Settings
    eveningBrief: {
    enabled: boolean,
    frequency: 'daily' | 'weekdays' | 'custom', customDays?: number[];
    deliveryTime: string,
    deliveryChannels: ('in-app' | 'email' | 'slack')[], contentModules: {
...
export interface MorningBriefData {
  ...
  // Delivery Status
    ...
    slack: {
        posted: boolean,
    postedAt?: string; channel?: string
...
export interface EveningBriefData {
  ...
  // Energy Level Achieved
    ...
    emblemAnimation: 'dim' | 'glowing' | 'pulsing' | 'vibrant', celebrationLevel: 'none' | 'subtle' | 'moderate' | 'extreme',
    motivationalMessage: string,
    nextDayGoal: string
  ...
  pendingItems: {
    ...
    quickActions: Array<{
      action: string,
    taskIds: string[], description: string
  }>
  }
...
export interface BriefingTemplate {
    ...
    name: string,
  description: string,
    category: 'morning' | 'evening' | 'both', settings: Partial<BriefingSettings>,
    isDefault: boolean,
  isPublic: boolean,
    createdBy: string,
    createdAt: string
  ...
  userId: string,
    period: 'daily' | 'weekly' | 'monthly', startDate: string,
    endDate: string,
  morningBrief: {
