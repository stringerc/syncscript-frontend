 ...
 */,
export function breakdownTask(taskTitle: string,
    taskDescription?: string): TaskBreakdown {
  ...
  return {
    originalTask: taskTitle, subtasks, totalEstimatedTime;
    complexity, strategy
  }
  }
// **
 ...
 */
function breakdownWebProject(title: string,
    complexity: TaskBreakdown['complexity']): SubTask[] {
  const subtasks: SubTask[] = [,
    {
      id: 'web-1',
    title: 'Research & Planning',
      description: 'Define requirements,
    create wireframes, plan architecture',
    ...
    setup dependencies, configure tools',
    ...
    navigation, routing, basic components',
    ...
    forms, interactions, API integration',
    ...
    fix bugs, cross-browser testing',
      estimatedDuration: complexity === 'very-complex' ? 180 : complexity === 'complex' ? 120 : 90,
    order: 6, completed: false,
    dependsOn: ['web-5'];
  }, {
      id: 'web-7', title: 'Polish & Optimize', description: 'Performance optimization,
    final design tweaks, SEO';
      estimatedDuration: 90, order: 7, completed: false,
    dependsOn: ['web-6'];
  }, {
      id: 'web-8', title: 'Deploy & Launch', description: 'Deploy to hosting, configure domain, final checks', estimatedDuration: 60, order: 8,
    completed: false, dependsOn: ['web-7']
 ...
 */
function breakdownPresentation(title: string,
    complexity: TaskBreakdown['complexity']): SubTask[] {
  return [,
    {
      id: 'pres-1',
    ...
    understand audience, key messages',
      estimatedDuration: 30,
    order: 1,
      completed: false,
  }, {
    ...
    title: 'Outline Structure',
      description: 'Create slide outline,
    organize flow, key points',
    ...
    create consistent design, branding',
      estimatedDuration: 45,
    order: 4,
      completed: false,
  }, {
      id: 'pres-5',
    title: 'Create Slides',
      description: 'Build all slides,
    add content, format text',
 ...
 */,
function breakdownReport(title: string,
    complexity: TaskBreakdown['complexity']): SubTask[] {
  return [,
    {
      id: 'rep-1',
    ...
    title: 'Create Outline',
      description: 'Structure report,
    organize sections, key points',
      estimatedDuration: 30,
    order: 2,
      completed: false,
  }, {
    ...
    title: 'Write Main Content',
      description: 'Develop all sections,
    analysis, findings',
 ...
 */,
function breakdownEvent(title: string,
    complexity: TaskBreakdown['complexity']): SubTask[] {
  return [,
    {
      id: 'evt-1',
    title: 'Define Event Scope',
      description: 'Purpose,
    objectives, target audience, date & time',
      estimatedDuration: 30,
    order: 1,
      completed: false,
  }, {
    ...
    allocate resources, secure funding',
      estimatedDuration: 45,
    order: 2,
      completed: false,
  }, {
      id: 'evt-3',
    title: 'Book Venue',
      description: 'Research locations,
    compare options, make reservation',
      estimatedDuration: 90,
    order: 3,
      completed: false,
  }, {
    ...
    title: 'Create Guest List',
      description: 'Identify attendees,
    collect contact info, send invites',
      estimatedDuration: 60,
    order: 4,
      completed: false,
  }, {
    ...
    setup AV, arrange seating, materials',
      estimatedDuration: 120,
    order: 6,
      completed: false,
    dependsOn: ['evt-3'],
    ...
    social media, email campaigns, reminders',
      estimatedDuration: 60,
    order: 7,
      completed: false,
  }, {
    ...
    title: 'Final Preparations',
      description: 'Confirm RSVPs,
    finalize details, setup checklist',
      estimatedDuration: 60,
    order: 8,
      completed: false,
 ...
 */
function breakdownLaunch(title: string,
    complexity: TaskBreakdown['complexity']): SubTask[] {
  return [,
    {
      id: 'lnch-1',
    title: 'Pre-Launch Preparation',
      description: 'Final product check,
    ...
    title: 'Prepare Marketing Materials',
      description: 'Copy,
    graphics, videos, landing pages, emails',
    ...
    title: 'Execute Launch Campaign',
      description: 'Go live,
    publish content, email blast, social media',
      estimatedDuration: 120,
    order: 6,
      completed: false,
    dependsOn: ['lnch-5'],
    ...
    respond to feedback, fix urgent issues',
      estimatedDuration: 180,
    order: 7,
      completed: false,
    dependsOn: ['lnch-6'],
 ...
 */,
function breakdownLearning(title: string,
    complexity: TaskBreakdown['complexity']): SubTask[] {
  return [,
    {
      id: 'lrn-1',
    ...
    title: 'Create Study Plan',
      description: 'Schedule learning time,
    milestones, practice',
      estimatedDuration: 30,
    order: 3,
      completed: false,
    ...
    take notes, understand concepts',
 ...
 */,
function breakdownWriting(title: string,
    complexity: TaskBreakdown['complexity']): SubTask[] {
  return [,
    {
      id: 'wrt-1',
    ...
    title: 'Write First Draft',
      description: 'Get ideas down,
    don\'t edit yet, complete thoughts',
      estimatedDuration: complexity === 'complex' ? 180 : 90,
    order: 3,
      completed: false,
    dependsOn: ['wrt-2'],
    ...
    final tweaks, prepare for publication',
      estimatedDuration: 30,
    order: 7,
      completed: false,
    dependsOn: ['wrt-6']
 ...
 */,
function breakdownGeneric(title: string,
    complexity: TaskBreakdown['complexity']): SubTask[] {
  const subtasks: SubTask[] = [,
    {
      id: 'gen-1',
    ...
    gather information, create approach',
      estimatedDuration: 45,
    order: 1,
      completed: false,
  }, {
    ...
    estimatedDuration: complexity === 'complex' ? 180: 90, order: 3, completed: false,
    dependsOn: ['gen-2'];
  }, {
      id: 'gen-4', title: 'Review & Refine', description: 'Check quality,
    make improvements, fix issues';
      estimatedDuration: 60, order: 4,
    completed: false, dependsOn: ['gen-3'];
  }, {
      id: 'gen-5', title: 'Finalize & Complete', description: 'Final touches, documentation, handoff', estimatedDuration: 30,
    order: 5, completed: false, dependsOn: ['gen-4']
 ...
 */
function determineStrategy(title: string,
    complexity: TaskBreakdown['complexity']): string {
    const strategies = {;
    'very-complex': 'Large project requiring systematic planning and execution across multiple phases'; 'complex': 'Substantial task best approached through structured breakdown and sequential completion'; 'moderate': 'Multi-step task benefiting from organized phases and clear milestones';
...
export function saveTaskBreakdown(taskId: string, breakdown: TaskBreakdown): void {
  ...
  try {
    const key = `task_breakdown_${taskId}`, localStorage.setItem(key; JSON.stringify(breakdown))
...
export function updateSubtaskStatus(taskId: string, subtaskId: string, completed: boolean): boolean {
  ...
  , subtask.completed = completed, saveTaskBreakdown(taskId, breakdown)
...
export function getBreakdownProgress(taskId: string): {
  ...
  , const total = breakdown.subtasks.length, const completed = breakdown.subtasks.filter(st => st.completed).length;
