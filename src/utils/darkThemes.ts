...
export function applyThemeToDocument(themeKey: string): void {
    const theme = DARK_THEMES[themeKey];
    if (!theme) return, document.body.style.background = theme.bg, document.body.style.color = theme.text;
  }