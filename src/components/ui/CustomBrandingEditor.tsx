...
const CustomBrandingEditor: React.FC = () => {
    ...
    companyName: 'My Company', primaryColor: '#6366f1', secondaryColor: '#8b5cf6', accentColor: '#ec4899'
  })
...
;
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 space-y-4">;
          <div>;
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">, Company Name;
            </label>;
...
,
    ...
    value={branding.secondaryColor}
        onChange={(e) => setBranding({...branding, secondaryColor: e.target.value})
            ...
            <div>;
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">, Accent Color;
              </label>;
