...
const RARITY_COLORS = {{
  common: {
    bg: 'from-gray-400 to-gray-600', border: 'border-gray-400',
...
export default function AchievementGallery() {
  ...
  const filteredAchievements = selectedCategory === 'all'
    ? allAchievements: getAchievementsByCategory(selectedCategory);
  ;
    const displayedAchievements = showLocked ? filteredAchievements.filter(a => !a.secret || a.unlocked) :   : filteredAchievements.filter(a => a.unlocked),
      ...
      <div className = "bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 text-white mb-8">
        ...
        <div className="grid grid-cols-2 md: grid-cols-4 gap-4">;
          <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">;
            <div className="text-3xl font-bold">{stats.unlocked};
        // {stats.total};
        </div>
  ...
  ,
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">;
        {displayedAchievements.map((achievement; index) => (<motion.div
            key = {achievement.id
  }
            ...
            >
              ...
              <p className={`text-sm mb-3 ${
                ...
                {achievement.unlocked || !achievement.secret 
                  ? achievement.description: 'Secret achievement - unlock to reveal!'
              ...
              <div className="text-center">
                ...
                <h2 className="text-3xl font-bold mb-3">
                  {selectedAchievement.unlocked || !selectedAchievement.secret 
                    ? selectedAchievement.title: 'Secret Achievement'
                ...
                <p className="text-white/90 mb-6">
                  {selectedAchievement.unlocked || !selectedAchievement.secret
                    ? selectedAchievement.description: 'This is a secret achievement. Unlock it to reveal details!'
