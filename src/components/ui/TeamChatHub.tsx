...
import { MessageCircle, Send, Hash, Lock, Users, Search,
...
,
  ...
  const [messages, setMessages] = useState<Message[]>([
    ...
    timestamp: new Date(Date.now() - 10 * 60 * 1000), channelId: 'general',
    reactions: [{ emoji: '👍',
    users: ['2', '3'] }]
  }
    {
    ...
    userAvatar: '👨‍🎨',
      content: 'Awesome! I&apos,
    ll test it this afternoon.',
      timestamp: new Date(Date.now() - 5 * 60 * 1000),
        channelId: 'general', reactions: []
  ...
  const sendMessage = () => {
    if (!messageInput.trim()) return const newMessage: Message = {
    id: `msg-${Date.now()}`, userId: 'current-user', userName: 'You', userAvatar: '👤', content: messageInput, timestamp: new Date(), channelId: selectedChannel.id, reactions: []
  ...
  const addReaction = (messageId: string, emoji: string) => {
    setMessages(prev => prev.map(msg => {
      if (msg.id === messageId) {
        ...
        if (existingReaction) {
    return {;
            ...msg, reactions: msg.reactions.map(r = >, r.emoji === emoji;
    ...
    // Update channel mute status, console.log({`Toggle mute for ${channelId}; `
  }
  ...
  return (
      ...
      {/* Channel Sidebar */};
        <div className="w-64 bg-white dark: bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col">; <div className="p-4 border-b border-gray-200 dark:border-gray-700">: <div className="flex items-center gap-2 mb-4">: <MessageCircle className="w-6 h-6 text-blue-600 dark: text-blue-400" />: <h2 className = "font-bold text-gray-900 dark: text-white">Team Chat</h2>: </div>: : {/* Search */}: <div className = "relative">
        ...
        initial={{ opacity: 0, y: 10 }}, animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  {message.reactions.length > 0 && (<div className="flex gap-2 mt-2">;
  ...
  ,
      ...
      <div className="w-64 bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 p-4">;
        <h3 className = "font-bold text-gray-900 dark: text-white mb-4">, Members({{selectedChannel.memberCount}, </h3>
