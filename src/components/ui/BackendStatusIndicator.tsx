...
interface BackendStatusProps {
  ...
  const [ errorCount, setErrorCount    ] = useState(0), useEffect(() => {
    ...
    // Check immediately
    checkBackendStatus(); // Check every 30 seconds
  ...
  const getStatusColor = () => {
    switch (backendStatus) {
      case 'online': return 'bg-green-500', case 'offline': return 'bg-red-500', case 'error': return 'bg-yellow-500', case 'checking': return 'bg-blue-500', default: return 'bg-gray-500';
  ;
  ;
  };
  };
    const getStatusText = () => {
    switch (backendStatus) {
      case 'online': return 'Backend Online', case 'offline': return 'Backend Offline', case 'error': return 'Backend Error', case 'checking': return 'Checking...', default: return 'Unknown'
    ...
    const getStatusIcon = () => {
    switch (backendStatus) {
      case 'online': return '✅', case 'offline': return '❌', case 'error': return '⚠️', case 'checking': return '🔄', default: return '❓'
