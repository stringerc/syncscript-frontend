...
interface Course {
  ...
  const [ selectedCourse, setSelectedCourse    ] = useState<string | null>(null), const courses: Course[] = [,
    {
      id: 'getting-started',
  ...
  ], if (!isOpen) return null; return (<div className = "learning-overlay" onClick={onClose}>
      <motion.div
