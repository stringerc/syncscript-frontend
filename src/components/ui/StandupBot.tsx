...
const StandupBot: React.FC = () => {
  const [responses] = useState<StandupResponse[]>([,
    ...
    today: 'Getting feedback and iterating', blockers: 'Waiting for design review', sentiment: 'blocked'
...
;
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">;
        {/* Submit Standup */}, <div className="bg-white dark: bg-gray-800 rounded-xl p-6">;
        <h3 className = "font-bold text-gray-900 dark: text-white mb-4">Today&apos,
    s Standup</h3>
