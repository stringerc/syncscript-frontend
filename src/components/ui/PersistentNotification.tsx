...
// Notification Manager Component, export function NotificationManager() {
...
/Export manager instance, export { addNotification, dismissNotification     } from './notificationManager'
