...
export default function CustomWorkspaceEditor({ isOpen, onClose, onSave }: CustomWorkspaceEditorProps) {
  const [ widgets, setWidgets    ] = useState<Widget[]>(defaultWidgets), if (!isOpen) return null;
  return (
    ...
    fontWeight: 'var(--font-bold)', marginBottom: 'var(--space-6)' }}>,
    ...
    padding: 'var(--space-4', border: '2px dashed var(--color-neutral-300)', borderRadius: 'var(--radius-lg)', cursor: 'move',
  }}>;
        ...
        onClose(); }}
            style = {{
              flex: 1, background: 'var(--color-primary-500)', color: 'white', padding: '14px', borderRadius: 'var(--radius-lg)', border: 'none', cursor: 'pointer', fontWeight: 'var(--font-semibold)'
            }}
          >
            Save Layout
          </button>
          <button
            ...
            style={{
              flex: 1, background: 'var(--color-neutral-100)', padding: '14px', borderRadius: 'var(--radius-lg)', border: 'none', cursor: 'pointer'
            }}
          >
            Cancel
          </button>
