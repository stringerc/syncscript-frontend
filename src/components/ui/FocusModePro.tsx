...
import { Zap, Play, Pause, SkipForward, Settings, Volume2,
...
const focusMusicGenres = [,
  { id: 'lo-fi',
    name: 'Lo-Fi Beats', icon: '🎵'  }, { id: 'classical',
    name: 'Classical', icon: '🎻'  }, { id: 'ambient',
    name: 'Ambient', icon: '🌊'  }, { id: 'nature',
    name: 'Nature Sounds', icon: '🌲'  }, { id: 'white-noise',
    name: 'White Noise', icon: '📻'  }, { id: 'binaural',
...
const FocusModePro: React.FC<FocusModeProProps> = ({
    onSessionComplete, enabledFeatures = {
    websiteBlocker: true,
    distractionFreeMode: true,
    focusMusic: true, analytics: true
  ...
  const startSession = () => {
    ...
    id: `session-${Date.now()}`, taskName: taskName || 'Focus Session', duration: selectedType.duration, type: selectedType.type, startTime: new Date(), completed: false, breaks: 0, distractions: 0
  ...
  const handleSessionComplete = () => {
    ...
    const completedSession: FocusSession = {
        ...sessionRef.current, endTime: new Date(), completed: true, breaks: breakCount, distractions: distractionCount}, setSessions(prev = > [completedSession, ...prev])
  ...
  const calculateStreak = () => {
    // Simple streak calculation - days with at least one session, let streak = 0;
    ...
    opacity: 1 }}
          ...
          <div className="relative w-64 h-64 mx-auto mb-8">;
            <svg className="w-64 h-64 transform -rotate-90">;
              <circle;
                cx="128", cy="128", r = "120", stroke="rgba(255,255,255,0.1)"
                strokeWidth="8"
                fill="none"
              // >
              <circle
  ...
  ,
      ...
      /*  Today's Stats  */ {enabledFeatures.analytics && (
  ...
  ,
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">, Distractions;
            </div>;
          </div>;
        </div>;
      ) }, {/* Main Content */
      ...
      <div className = "flex-1 grid grid-cols-2 gap-6">
        ...
        <div className="bg-white dark: bg-gray-800 rounded-xl p-6">
          ...
          {!isActive ? (<div className="space-y-4">
              {/* Task Name */ : }  : <div>  : <label className="block text-sm font-medium text-gray-700 dark : text-gray-300 mb-2">, What are you working on ? </label> : <input  : type="text"  : value={taskName  :   :   : }  : onChange={(e) => setTaskName(e.target.value)  : }  : placeholder="e.g., Write project proposal"
...
;
              ...
              /*  Distraction-Free Toggle  */ {enabledFeatures.distractionFreeMode && (
                <button
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6">;
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">, Recent Sessions;
            </h3>;
            <div className="space-y-2">;
