...
const StreakCounter: React.FC<StreakCounterProps> = ({
    loginStreak, completionStreak,
  longestLoginStreak, longestCompletionStreak
}) => {
  const loginMilestone = getStreakMilestone(loginStreak);
    const completionMilestone = getStreakMilestone(completionStreak), return (
    ...
    ease: "easeInOut"
      ...
      {completionStreak > 0 && (
        ...
        >;
          <div className="streak-icon-wrapper">;
            <motion.div, className="streak-checkmark", animate = {{
                scale: [1, 1.1, 1]
  }}
              transition={{
