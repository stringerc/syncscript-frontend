  ...
  return (
    <>
      ...
      <button
        ...
        className="global-navigation fixed bottom-6 left-20 w-16 h-16 bg-gradient-to-r from-purple-600 to-blue-600 rounded-full shadow-2xl hover:shadow-3xl transition-all hover:scale-110 flex items-center justify-center text-3xl focus:outline-none focus:ring-4 focus:ring-purple-300 z-50"
