...
export type SortOption = 'priority' | 'due_date' | 'points' | 'energy_match' | 'created_at', interface TaskSearchProps {
    searchQuery: string,
  ...
  onSortChange: (option: SortOption) => void,
    ...
    searchQuery, onSearchChange, sortBy, onSortChange, resultsCount, totalCount
}) => {
  return (<div className = "task-search">
...
;
      ...
      {(searchQuery || resultsCount !== totalCount) && (;
        <motion.div, className="results-count", initial = {{ opacity: 0, y: -10 }}, animate = {{ opacity: 1, y: 0 }}
        >
          <svg viewBox = "0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
