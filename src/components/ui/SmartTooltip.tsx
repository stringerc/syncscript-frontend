...
interface SmartTooltipProps {
  ...
  const calculatePosition = () => {
    if (!triggerRef.current || !tooltipRef.current) return const triggerRect = triggerRef.current.getBoundingClientRect()
  ...
  const getTooltipStyle = () => {
    ...
    position: 'fixed', zIndex: 1700 /From z-index system
  ...
  }, className="tooltip pointer-events-none", role="tooltip";
          >;
