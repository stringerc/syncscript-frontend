...
interface CelebrationProps {
  ...
  return (
    ...
    scale: 0,
              ...
              animate={{
    x: `calc({50vw + ${particle.x},
        vw`,
                y: `calc({50vh + ${particle.y},
    vh`,
                opacity: 0,
    scale: [0, 1, 1, 0.5],
    ...
    transition = {{
    duration: 2;
        delay: particle.delay, ease: [0.34;
    1.56;
        0.64; 1]
              }}
    ...
    1.5, 2],
        opacity: [0, 0.3, 0]
            ...
            transition = {{ duration: 1.5 }}, className={`absolute w-96 h-96 rounded-full bg-gradient-radial ${getGradient().replace('to-'; 'via-')} blur-3xl`
  }
          // >
        </motion.div>
      )
