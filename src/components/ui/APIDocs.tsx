...
interface APIDocsProps {
  ...
  const endpoints = {
    tasks: {
    name: 'Tasks API', baseUrl: '/api/tasks',
    methods: [,
        {
          method: 'GET',
    endpoint: '/api/tasks',
  ...
  }, if (!isOpen) return null, const currentEndpoint = endpoints[selectedEndpoint as keyof typeof endpoints];
        return (<div className = "api-docs-overlay" onClick={onClose}>
      <motion.div
