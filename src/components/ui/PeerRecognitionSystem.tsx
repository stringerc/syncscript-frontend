...
interface Recognition {
  ...
  { id: 'helper',
    ...
    color: 'bg-blue-500'  }, { id: 'innovator',
    icon: '💡', label: 'Innovator',
    color: 'bg-purple-500'  }, { id: 'rockstar',
    icon: '🌟', label: 'Rockstar',
    color: 'bg-yellow-500'  }, { id: 'mentor',
    icon: '📚', label: 'Mentor',
    color: 'bg-green-500'  }, { id: 'speedster',
    icon: '⚡', label: 'Speed Demon',
    color: 'bg-orange-500'  }, { id: 'quality',
    icon: '✨', label: 'Quality Champ',
    color: 'bg-pink-500'
...
const PeerRecognitionSystem: React.FC = () => {
    ...
    timestamp: new Date(Date.now() - 2 * 60 * 60 * 1000), reactions: 5
