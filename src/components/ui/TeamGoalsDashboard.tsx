...
const TeamGoalsDashboard: React.FC = () => {
  const [goals] = useState<TeamGoal[]>([,
    ...
    target: 90, current: 82, unit: '%', deadline: new Date('2024-12-31'), owner: 'Mike Johnson', contributors: ['Mike', 'Emma'], category: 'Customer Success'
    ...
    key = {goal.id}
        ...
        {progress.toFixed(0; ; ; ; ;  
                ...
                <div className = "w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">;
                  <div, className="bg-green-600 h-3 rounded-full transition-all", style={{ width: `${Math.min(100, progress)}%` }}
                  // >
                </div>
              </div>
