...
const TeamInvitation: React.FC<TeamInvitationProps> = ({
  ...
  const [ isValidating, setIsValidating    ] = useState(true), const [isValid, setIsValid] = useState(false), const [error, setError] = useState<string | null>(null), const [isProcessing, setIsProcessing] = useState(false), useEffect(() => {
  ...
  const validateInvitation = async () => {
    setIsValidating(true), setError(null), try {
        // In a real app, you'd validate the token with the backend
      // For now, we'll simulate validation
      await new Promise(resolve => setTimeout(resolve, 1000)); // Mock validation - in reality, this would be an API call
      const mockInvite = {{
        id: 'mock-invite-id',
    teamId: team.id,
    ...
    }} const valid = validateInviteToken(mockInvite), setIsValid(valid);
    if (!valid) {
  ...
  return (<AnimatePresence>
    ...
    y: 20 }}, transition={{ type: 'spring', stiffness: 300, damping: 30 }}
            onClick = {(e
              ...
              {isValidating ? (
                ...
                <>
                  ...
                  <div className="inviter-info">
                    ...
                    <div className="inviter-details">;
                      ...
                      <div className="inviter-role">;
                        <span , className="role-badge", style={{ color: getRoleInfo(inviter.role).color }};
                        >;
                  ...
                  <div className="invitation-terms">;
                    <p>, By accepting this invitation; you agree to join the team and 
