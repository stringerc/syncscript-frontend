...
const PermissionsManager: React.FC = () => {
    const [roles] = useState<Role[]>(defaultRoles), const [ selectedRole, setSelectedRole    ] = useState<Role | null>(null)
...
;
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">;
          {roles.map(role => (;
            <motion.div, key = {role.id}, initial = {{ opacity: 0,
    y: 20 }},
...
;
        {selectedRole && (<div className="mt-6 bg-white dark:bg-gray-800 rounded-xl p-6">;
