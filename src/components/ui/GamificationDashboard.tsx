...
export default function GamificationDashboard() {
  ...
  const tabs = [
    { id: 'overview',
    label: 'Overview', icon: '🌟'  }, { id: 'streaks',
    label: 'Streaks', icon: '🔥'  }, { id: 'achievements',
    label: 'Achievements', icon: '🏆'  }, { id: 'goals',
    label: 'Goals', icon: '🎯'  }, { id: 'rewards',
    label: 'Rewards', icon: '🎁'  }, { id: 'marketplace',
...
;
    ...
    className="bg-gradient-to-br from-yellow-500 to-orange-600 rounded-2xl p-6 text-white shadow-xl";
        ...
        <div className="text-xs text-white/60 mt-2">{achievementStats.percentage.toFixed(0; ; ;  
...
;
            ...
            {activeTab === 'streaks' && (
              <div>
                <h2 className="text-2xl font-bold text-gray-900 dark: text-white mb-6">, Streak Management;
                </h2>;
                <StreakDisplay />;
              </div>;
            ...
            {activeTab === 'rewards' && (;
              <div>;
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">, Daily Login Rewards;
                </h2>;
                <CustomizationPanel />;
              </div>;
