...
const FileSharingHub: React.FC = () => {
    ...
    { id: '1', name: 'Q4-Report.pdf', type: 'pdf', size: 2400000, uploadedBy: 'Sarah', uploadedAt: new Date(), folder: 'Reports', downloads: 12, isStarred: true  }, { id: '2', name: 'Design-Mockup.fig', type: 'figma', size: 8900000, uploadedBy: 'Mike', uploadedAt: new Date(), folder: 'Design', downloads: 8, isStarred: false
