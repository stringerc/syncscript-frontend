...
interface GoalProgressCardProps {
    ...
    onUpdate?: () => void
        ...
        export default function GoalProgressCard({ goal, onUpdate }: GoalProgressCardProps) { const { celebration, updateGoalWithCelebration, clearCelebration } = useGoalCelebration()
      ...
      >
        ...
        <div className="mb-4">;
          <div className="h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">;
            <motion.div;
              initial={{ width: 0 }}, animate={{ width: `${progress.percentage}%` }}, transition = {{ duration: 0.8, ease: "easeOut" }}
  ...
  }, className="flex-1 px-3 py-2 text-sm font-medium rounded-lg transition-all hover:scale-105 active:scale-95", style = {{
                backgroundColor: `${goal.color}20`, color: goal.color, border: `2px solid ${goal.color}`
              }}
            >
              +${amount
  }
