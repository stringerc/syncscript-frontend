...
interface MorningBriefProps {
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>,
                        <h1 className="text-3xl font-bold text-white mb-2">,
                          {getGreeting()}, Ready to Launch ? </h1>
    ...
    day: 'numeric' 
                ...
                <div className="p-8 space-y-8 max-h-96 overflow-y-auto custom-scrollbar">
                  ...
                  >
                    ...
                    {data.previousDay.notableAccomplishments.length > 0 && (<div className="mt-4">;
  ...
  } : </div>  : </div>  : </motion.div>  : ))  : }  : </div>  : </div>  : </motion.div>  :   : {/* Energy Game Plan */  : }  : <motion.div : initial={{ opacity : 0,
    x: -20 }},
                    animate={{ opacity: 1,
    x: 0 }}
                  ...
                  >
                    ...
                    <div className="mb-4">,
                      ...
                      <div className="w-full bg-white/10 rounded-full h-3">,
                        <motion.div,
                          initial={{ width: 0 }}, animate={{ width: `${(data.energyGamePlan.currentEnergy / 10) * 100}%` }}, transition={{ duration: 1, delay: 0.5 }}, className="bg-gradient-to-r from-yellow-400 to-orange-500 h-3 rounded-full";
                        // >;
                      </div>;
                    </div>;
;
