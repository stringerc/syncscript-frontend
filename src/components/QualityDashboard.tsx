...
export function QualityDashboard() {
  ...
  return (
        ...
        ;
        <motion.div, style = {{
        background: 'white', padding: '24px', borderRadius: '12px', border: '1px solid #E5E7EB',
    ...
    0;
      ...
      whileHover = {{ boxShadow: '0 4px 8px rgba(0,
    0,0,0.1)' }}
    >
...
function AcceptanceBar({ name, status, score }: { name: string,
    status: 'pass' | 'fail', score: number }) {
  return (
        ,
        ,
        ,
    ...
    marginBottom: '4px' }}>{name}</div>,
        <div style={{ fontSize: '14px',
    color: '#6B7280' }}>{score}% compliance</div>,
      </div>,
      <div style={{
        padding: '6px 16px',
  ...
  return (
        ...
        ;
    <div style = {{
      background: 'white', padding: '20px', borderRadius: '12px', border: '1px solid #E5E7EB', textAlign: 'center',
  }}>;
