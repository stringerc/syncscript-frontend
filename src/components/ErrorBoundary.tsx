      ...
      return (
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">;
          <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-xl shadow-xl p-8 text-center">;
            ...
            ;
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">, Oops! Something went wrong;
            </h2>;
            ;
            <p className = "text-gray-600 dark: text-gray-400 mb-6">, We encountered an unexpected error. Don&apos;
        t worry;
        your data is safe.
            </p>
...
;
            <p className = "text-xs text-gray-500 dark: text-gray-400 mt-6">, If this problem persists, please contact support.
            </p>
          </div>
        </div>
      )
