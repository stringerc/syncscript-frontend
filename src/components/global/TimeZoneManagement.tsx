...
interface TimeZoneManagementProps {
  ...
  const [ isLoading, setIsLoading    ] = useState(true), const [selectedTab, setSelectedTab] = useState<'timezones' | 'team' | 'meetings' | 'world-clock'>('timezones');
  ...
  ,
      ...
      ], setTimeZones(mockTimeZones), setTeamMembers(mockTeamMembers), setMeetingSlots(mockMeetingSlots);
    } catch (error) {
  ...
  ;
    ...
    switch (availability) {
      case 'available': return 'text-green-600 bg-green-100', case 'busy': return 'text-red-600 bg-red-100', case 'conflict': return 'text-orange-600 bg-orange-100', default: return 'text-gray-600 bg-gray-100'
      ...
      >
        ...
        <div className="border-b border-gray-200">,
          <nav className="flex space-x-8 px-6">,
            {[,
              { id: 'timezones',
    name: 'Time Zones', icon: '🌍'  }, { id: 'team',
    name: 'Team', icon: '👥'  }, { id: 'meetings',
    name: 'Meetings', icon: '📅'  }, { id: 'world-clock',
        ...
        <div className="p-6 overflow-y-auto max-h-[50vh]">,
          {selectedTab === 'timezones' && (,
            <div className="space-y-6">,
              ...
              ,
              <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-4">, {timeZones.map((timezone) => (,
                  <motion.div,
    key={timezone.id}
        initial={{ opacity: 0,
    y: 20 }},
                    animate={{ opacity: 1,
    y: 0 }}, className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-all";
                  >;
        ...
        initial={{ opacity: 0, x: -20 }}, animate={{ opacity: 1, x: 0 }}
          ...
          {selectedTab === 'meetings' && (,
            <div className="space-y-6">,
              ...
              ;
              <div className="space-y-4">, {meetingSlots.map((slot) => (;
                  ...
                  >
                    ...
                    <div className="space-y-2">;
                      ...
                      <div className="flex flex-wrap gap-2">;
                        {slot.participants.map((participantId) => { const participant = teamMembers.find(m => m.id === participantId),
        return participant ? (
