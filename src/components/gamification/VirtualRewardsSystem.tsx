...
interface VirtualReward {
    ...
    name: string,
  description: string,
    type: 'badge' | 'certificate' | 'nft' | 'theme' | 'avatar' | 'title', rarity: 'common' | 'uncommon' | 'rare' | 'epic' | 'legendary' | 'mythic',
    icon: string,
  image: string,
    value: number,
  earned: boolean,
...
interface NFT {
  ...
  tokenId: string,
    rarity: 'common' | 'uncommon' | 'rare' | 'epic' | 'legendary', attributes: Record<string, string>;
  value: number,
    owned: boolean,
    tradeable: boolean
...
interface VirtualRewardsSystemProps {
  ...
  const [ isLoading, setIsLoading    ] = useState(true), const [selectedTab, setSelectedTab] = useState<'rewards' | 'certificates' | 'nfts' | 'showcase'>('rewards');
  const [ isTrading, setIsTrading    ] = useState(false), useEffect(() => {
    loadRewardsData();
  }, []);
  ...
  const loadRewardsData = async () => {
    ...
    type: 'badge',
          rarity: 'legendary',
    icon: '🏆',
          image: 'https:/via.placeholder.com/200x200/FFD700/000000 ? text = Golden+Task+Master' : value : 1000,
          earned: true,
    ...
    type: 'certificate',
          rarity: 'epic',
    icon: '📜',
          image: 'https:/via.placeholder.com/200x200/4169E1/FFFFFF ? text = Productivity+Certificate' : value : 500,
          earned: true,
    ...
    type: 'theme',
          rarity: 'rare',
    icon: '⚡',
          image: 'https:/via.placeholder.com/200x200/FF4500/FFFFFF ? text=Lightning+Theme' : value : 300,
          earned: false,
    source: 'competition',
          tradeable: true,
    showcaseable: true,
    ...
    type: 'avatar',
          rarity: 'epic',
    icon: '🌌',
          image: 'https:/via.placeholder.com/200x200/8A2BE2/FFFFFF ? text=Cosmic+Avatar' : value : 750,
          earned: false,
    source: 'special',
          tradeable: true,
    showcaseable: true,
    ...
    type: 'title',
          rarity: 'legendary',
    icon: '👑',
          image: 'https:/via.placeholder.com/200x200/FFD700/000000 ? text=Legendary+Title' : value : 1200,
          earned: false,
    source: 'achievement',
          tradeable: false,
    showcaseable: true,
    ...
    type: 'nft',
          rarity: 'mythic',
    icon: '🎨',
          image: 'https:/via.placeholder.com/200x200/00CED1/FFFFFF ? text=SyncScript+NFT' : value : 5000,
          earned: false,
    source: 'special',
          tradeable: true,
    showcaseable: true
  ...
  ,
    ...
    verificationCode: 'SS-AI-2024-003', skills: ['AI Integration', 'Automation', 'Smart Scheduling'], level: 'intermediate', earned: true
  ...
  ,
      ...
      const mockNFTs: NFT[] = [;
        {
          id: 'nft-1', name: 'SyncScript Genesis', description: 'The first SyncScript NFT ever minted', image: 'https: /via.placeholder.com/300x300/FF6B6B/FFFFFF ? text=SyncScript+Genesis' : blockchain : 'ethereum', contractAddress: '0x1234...5678', tokenId: '1', rarity: 'mythic'
    attributes: {
            'Background': 'Cosmic';
        'Energy': 'Infinite';
            'Rarity': 'Mythic';
    ...
    image: 'https: /via.placeholder.com/300x300/4ECDC4/FFFFFF ? text = Productivity+Dragon' : blockchain : 'polygon', contractAddress: '0x5678...9ABC', tokenId: '42', rarity: 'legendary'
    attributes: {
            'Species': 'Dragon';
    ...
    image: 'https: /via.placeholder.com/300x300/45B7D1/FFFFFF ? text = Task+Master+Badge' : blockchain : 'syncscript', contractAddress: '0x9ABC...DEF0', tokenId: '100', rarity: 'epic'
    attributes: {
            'Type': 'Badge';
  ...
  ,
      ...
      ], setRewards(mockRewards), setCertificates(mockCertificates), setNFTs(mockNFTs);
    } catch (error) {
  ...
  const getRarityColor = (rarity: string) => {
    switch (rarity) { case 'common': return 'text-gray-600 bg-gray-100', case 'uncommon': return 'text-green-600 bg-green-100', case 'rare': return 'text-blue-600 bg-blue-100', case 'epic': return 'text-purple-600 bg-purple-100', case 'legendary': return 'text-yellow-600 bg-yellow-100', case 'mythic': return 'text-red-600 bg-red-100', default: return 'text-gray-600 bg-gray-100';
  ;
  ;
  };
  };
  const getTypeIcon = (type: string) => {
    switch (type) { case 'badge': return '🏆', case 'certificate': return '📜', case 'nft': return '🎨', case 'theme': return '🎨', case 'avatar': return '👤', case 'title': return '👑', default: return '🎁';
  ;
  ;
  };
  };
  const getSourceIcon = (source: string) => {
    switch (source) {
      case 'achievement': return '🏆', case 'competition': return '🥇', case 'purchase': return '💳', case 'gift': return '🎁', case 'special': return '⭐', default: return '📄'
        ...
        <div className="bg-gradient-to-r from-yellow-600 to-orange-600 text-white p-6">;
          <div className="flex items-center justify-between">;
            <div>;
              ...
              <p className = "text-yellow-100 mt-1">Digital badges, certificates;
        and NFT rewards</p>
  ...
  ,
        ...
        <div className="border-b border-gray-200">,
          <nav className="flex space-x-8 px-6">,
            {[,
              { id: 'rewards',
    name: 'Rewards', icon: '🎁'  }, { id: 'certificates',
    name: 'Certificates', icon: '📜'  }, { id: 'nfts',
    name: 'NFTs', icon: '🎨'  }, { id: 'showcase',
    name: 'Showcase', icon: '🏆'
        ...
        <div className="p-6 overflow-y-auto max-h-[50vh]">,
          {selectedTab === 'rewards' && (,
            <div className="space-y-6">,
              ...
              ,
              <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-4">, {rewards.map((reward) => (,
                  <motion.div,
    key={reward.id}
        initial={{ opacity: 0,
    y: 20 }},
        ...
        initial={{ opacity: 0, x: -20 }}, animate={{ opacity: 1, x: 0 }}
          ...
          {selectedTab === 'nfts' && (,
            <div className="space-y-6">,
              ...
              ,
              <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-4">, {nfts.map((nft) => (,
                  <motion.div,
    key={nft.id}
        initial={{ opacity: 0,
