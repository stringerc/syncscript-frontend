...
export default function () {
  const BASE_URL = __ENV.API_URL || 'https: //www.syncscript.app', // Homepage
  let res = http.get({`${BASE_URL},/`, check(res, {
  ...
  // Features page
  res = http.get({`${BASE_URL},/features`, check(res, {
...
HTTP Request Duration: p50: ${metrics.http_req_duration.values['p(50)']}ms
